 ...
 * a <code>Connector</code> via its {@link org.eclipse.californium.elements.Connector#setRawDataReceiver(org.eclipse.californium.elements.RawDataChannel)}
 * method in order to get notified about incoming messages.
 * 
 * Applications should use the {@link org.eclipse.californium.elements.Connector#send(org.eclipse.californium.elements.RawData)} method to send
