...
/**
 * ConnectorBase is a partial implementation of a {@link org.eclipse.californium.elements.Connector}. It connects
 ...
 * outgoing queue for a {@link org.eclipse.californium.elements.RawData} message to send. Both
...
public abstract class ConnectorBase implements Connector {
	 ...
	 * {@link org.eclipse.californium.elements.ConnectorBase#getNextOutgoing()} and
	 * {@link org.eclipse.californium.elements.ConnectorBase#receiveNext()}. Therefore, exceptions do not crash
	...
	private abstract class Worker extends Thread {
		...
		/**
		 * Override this method and call {@link org.eclipse.californium.elements.ConnectorBase#receiveNext()} or
		 * {@link org.eclipse.californium.elements.ConnectorBase#sendNext()}.
		 * 
