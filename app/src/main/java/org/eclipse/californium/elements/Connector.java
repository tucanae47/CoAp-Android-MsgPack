 ...
 * applications can use the {@link #send(org.eclipse.californium.elements.RawData)} method to send messages
 * (wrapped in a {@link org.eclipse.californium.elements.RawData} object) to a client via the network. Processing of
 ...
 * 
 * Implementations of the {@link #send(org.eclipse.californium.elements.RawData)} method should be non-blocking
...
public interface Connector {
	 ...
	 * 
	 * The handler's {@link RawDataChannel#receiveData(org.eclipse.californium.elements.RawData)} method
