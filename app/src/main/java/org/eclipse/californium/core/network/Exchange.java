 ...
 * of {@link org.eclipse.californium.core.coap.Request}s and {@link org.eclipse.californium.core.coap.Response}s. The Exchange only contains state,
 ...
 * <p>
 * The class {@link org.eclipse.californium.core.server.resources.CoapExchange} provides the corresponding API for developers.
 * Proceed with caution when using this class directly, e.g., through
 * {@link org.eclipse.californium.core.server.resources.CoapExchange#advanced()}.
 * <p>
...
public class Exchange {
	 ...
	 * {@link org.eclipse.californium.core.network.stack.BlockwiseLayer} should only work with the {@link #currentRequest}
	 ...
	 * below the {@link org.eclipse.californium.core.network.stack.BlockwiseLayer} should only work with the
	 ...
	 * @see #setCurrentRequest(org.eclipse.californium.core.coap.Request)
	 */
