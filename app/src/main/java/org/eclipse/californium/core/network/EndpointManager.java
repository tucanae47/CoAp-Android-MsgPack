 ...
 * application sends a request by calling {@link org.eclipse.californium.core.coap.Request#send()} the send method
...
public class EndpointManager {
	 ...
	 * {@link org.eclipse.californium.core.network.EndpointManager.ClientMessageDeliverer} rejects it. To receive requests, the
	 ...
	 * at the endpoint, the {@link org.eclipse.californium.core.network.EndpointManager.ClientMessageDeliverer} rejects it. To
	 ...
	 * {@link org.eclipse.californium.core.server.MessageDeliverer}. When a response arrives it adds it to the
