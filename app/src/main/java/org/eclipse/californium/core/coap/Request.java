...
/**
 * Request represents a CoAP request and has either the {@link org.eclipse.californium.core.coap.CoAP.Type} CON or NON
 * and one of the {@link org.eclipse.californium.core.coap.CoAP.Code}s GET, POST, PUT or DELETE. A request must be
