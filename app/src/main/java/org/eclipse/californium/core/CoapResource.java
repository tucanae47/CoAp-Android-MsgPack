 ...
 * <tt>handleGET(CoAPExchange)</tt> for instance. The class {@link org.eclipse.californium.core.network.Exchange} is
 ...
 * CoAP client is represented by an instance of {@link org.eclipse.californium.core.observe.ObserveRelation}.
 * <p>
 * In contrast the class {@link org.eclipse.californium.core.server.resources.ResourceObserver} has nothing to do with CoAP's
...
public  class CoapResource implements Resource {
	 ...
	 * {@link #handleGET(org.eclipse.californium.core.server.resources.CoapExchange)}, {@link #handlePOST(org.eclipse.californium.core.server.resources.CoapExchange)},
	 * {@link #handlePUT(org.eclipse.californium.core.server.resources.CoapExchange)}, and {@link #handleDELETE(org.eclipse.californium.core.server.resources.CoapExchange)},
	 * which provide a better API through the {@link org.eclipse.californium.core.server.resources.CoapExchange} class.
	 * 
	 ...
	 * {@link org.eclipse.californium.core.server.ServerMessageDeliverer} already created the relation, as it
